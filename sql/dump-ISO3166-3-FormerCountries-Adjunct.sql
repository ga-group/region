...
DB.DBA.XML_SET_NS_DECL('lcc-639-1', 'https://www.omg.org/spec/LCC/Languages/ISO639-1-LanguageCodes/', 3);
DB.DBA.XML_SET_NS_DECL('lcc-639-2', 'https://www.omg.org/spec/LCC/Languages/ISO639-2-LanguageCodes/', 3);
...
DB.DBA.XML_SET_NS_DECL('lcc-lr', 'https://www.omg.org/spec/LCC/Languages/LanguageRepresentation/', 3);
DB.DBA.XML_SET_NS_DECL('sm', 'http://www.omg.org/techprocess/ab/SpecificationMetadata/', 3);
...
CREATE DUMP_PROCEDURE(dump_iso3166_3adj,
SPARQL
DEFINE input:storage ""
PREFIX lcc-cr: <https://www.omg.org/spec/LCC/Countries/CountryRepresentation/>
PREFIX delta: <http://www.w3.org/2004/delta#>
SELECT ?s ?p ?o
FROM <https://www.omg.org/spec/LCC/Countries/ISO3166-3-FormerCountries-Adjunct/>
WHERE {
	?s ?p ?o .
}
);
